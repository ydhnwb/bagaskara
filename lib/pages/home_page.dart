...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          PopupMenuButton<String>(
            ...
            itemBuilder: (context){
              return choices.map((String choice) => PopupMenuItem(
                  value: choice,
                  child: Text(choice),
                )
              ).toList();
      ...
      body: BlocListener<AksaraBloc, AksaraState>(
                              ...
                              children: <Widget>[
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    width: _size.width,
                                    alignment: Alignment.centerLeft,
                                    child: Text((_latinToAksara) ? "Latin" : "Aksara", style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 18
                                    ),),
                                  ),
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    width: _size.width,
                                    alignment: Alignment.centerRight,
                                    child: Text((_latinToAksara) ? "Aksara" : "Latin", style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 18
                                    ),),
                                  ),
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Spacer(),
                                    if(_domainTextController.text.toString().trim().isNotEmpty)
                                      IconButton(
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintText: (_latinToAksara) ? "Tulis sesuatu dalam latin" : "Tulis sesuatu dalam aksara jawa"
                                    ),
                                onChanged: (String s) {
                                  if(_latinToAksara){
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Text(_targetText, style: TextStyle(
                                fontSize: 24,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed:() => _aksaraBloc.add(ScanFromCamera()),
